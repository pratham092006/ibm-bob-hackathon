...
Usage:
    ...
    python switch_llm.py status       # Show current provider
"""
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python switch_llm.py [claude|gemini|openrouter|nvidia|ollama|status]")
        show_status()
        sys.exit(1)
